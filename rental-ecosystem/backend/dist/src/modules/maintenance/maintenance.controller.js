...
__decorate([
    ...
    __metadata("design:paramtypes", [create_maintenance_dto_1.CreateMaintenanceDto, String]),
    __metadata("design:returntype", Promise)
], MaintenanceController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)('tenant', 'landlord', 'agent'),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)('agent', 'landlord'),
